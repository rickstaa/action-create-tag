# Contributing to action-create-tag
...
## Report bugs using Github's [issues](https://github.com/rickstaa/action-create-tag/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/rickstaa/action-create-tag/issues/new/choose); it's that easy!
